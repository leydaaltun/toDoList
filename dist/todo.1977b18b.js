...
if (localStorage.getItem('savedToDos')) {
  ...
  var parsed = JSON.parse(savedToDos);
  console.log(parsed);
  toDos = parsed;
}
...
function getToDo(toDo, index) {
  ...
  return "\n    <div class='todo ".concat(className, "' data-index='").concat(index, "'>\n        ").concat(text, "\n    </div>");
} //console.log(getToDo(toDos[1]))


var parent = document.querySelector('.todo-list'); //parent.innerHTML = getToDo(toDos[1])

var toDoCount = document.querySelector('.todoCount'); //console.log(toDoCount)

function updateHTML() {
  var html = '';
  toDos.forEach(function (item, index) {
    var toDo = getToDo(item, index);
    html += toDo;
  });
  console.log(html);
...
var toDoElems = _toConsumableArray(document.querySelectorAll('.todo')); //console.log(toDoElems)
...
function handleClick(element) {
  var index = element.dataset.index; //console.log(index)

  var isDone = toDos[index].isDone;

  if (isDone) {
    // this means === true
    toDos[index].isDone = false; //console.log(true)
  } else {
    toDos[index].isDone = true; //console.log(false)
  }
...
},{}]},{},["../../Users/leyda/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","todo.js"], null)
